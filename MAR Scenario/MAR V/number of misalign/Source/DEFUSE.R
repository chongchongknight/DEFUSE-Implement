## data generation process for changed sample size and number of misaligned
mix_gaussian <- function(n_site, n_total, dim, Miss, gamma.bar, seednum, size, nmissing){
  #c = 0.2
  #b = 1
  # size = para1
  # nmissing = para2
